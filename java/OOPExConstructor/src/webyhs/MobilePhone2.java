...
public class MobilePhone2 {
	...
	// 생성자 오버로딩
	public MobilePhone2(String brand, String model, int memory, String color) {
	...
	public MobilePhone2(String brand, String model) {
		this(brand, model, 256, "검정색");
	}
	public MobilePhone2(String brand, int memory) {
